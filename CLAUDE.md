...
Read `AGENTS.md` first. It is the shared rulebook for Claude and Codex (file ownership, handoff steps, lighting constants, merge order), and it wins if this file disagrees.
...
| `/Users/dpalm/Desktop/deanhack-codex` | Codex branches | Codex | Codex's own port |
...
- **Stay in this worktree.** Never edit, commit in, or run dev servers from another checkout.
...
- `bridge.c` belongs to Codex. If a visual change needs a new protocol field, write the request in the handoff log instead of editing it.
