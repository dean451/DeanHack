...
#ifdef ASTRAL_ESCAPE
static NEARDATA const char sacrifice_types[] = { AMULET_CLASS, FOOD_CLASS, 0 };
#endif
...
cprefx(int pm)
{
    ...
    case PM_DISENCHANTER:
        ...
        if ((!flags.perma_hallu && Hallucination) ? rn2(5) : rn2(2)) {
            attrcurse();
        }
